...
cercle_A = plt.Circle((hA, kA), rA, color='blue', fill=False, linestyle='-', linewidth=1.5, label="Cercle A")
cercle_B = plt.Circle((hB, kB), rB, color='red', fill=False, linestyle='-', linewidth=1.5, label="Cercle B")
cercle_C = plt.Circle((hC, kC), rC, color='green', fill=False, linestyle='-', linewidth=1.5, label="Cercle C")
...
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.set_title("Cercles passant par les points des jeux A, B et C")
ax.legend()
...
plt.title('Conditionnement de Ṽ(Qn) vs 2^n en fonction de n')
plt.legend()
...
plt.title('Erreur relative et borne théorique en fonction de n')
plt.legend()
plt.show()